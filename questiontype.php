...
class qtype_musickeysignature extends question_type {
    ...
    */
    ...
    function backup($bf,$preferences,$question,$level=6) {
        ...
        $status = true;
        $scaleqs = get_records('question_musickeysignature','questionid',$question,'id ASC');
    ...
    function restore($old_question_id,$new_question_id,$info,$restore) {
        ...
        for($i=0; $i<sizeof($scaleqs); $i++) {
            ...
            if (!insert_record('question_musickeysignature',$scale)) {
...
//question_register_questiontype(new musickeysignature_qtype());
